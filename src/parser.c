...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [121] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_param_interface_repeat1, 2),
  [123] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_param_interface_repeat1, 2), SHIFT_REPEAT(77),
  [126] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_routine, 4),
  [128] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_import, 3),
  [130] = {.entry = {.count = 1, .reusable = true}}, SHIFT(76),
  [132] = {.entry = {.count = 1, .reusable = true}}, SHIFT(77),
  [134] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_routine, 5),
  [136] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_routine, 6),
  ...
  [156] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_sequence_repeat1, 1),
  [158] = {.entry = {.count = 1, .reusable = true}}, SHIFT(44),
  [160] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_sub_repeat1, 2),
  [162] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_sub_repeat1, 2), SHIFT_REPEAT(74),
  [165] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_param_def, 3),
  [167] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_op, 1),
  [169] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_sequence_repeat1, 2),
  [171] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_sequence_repeat1, 2), SHIFT_REPEAT(49),
  [174] = {.entry = {.count = 1, .reusable = true}}, SHIFT(73),
  [176] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_jump, 2),
  [178] = {.entry = {.count = 1, .reusable = true}}, SHIFT(34),
  [180] = {.entry = {.count = 1, .reusable = true}}, SHIFT(70),
  [182] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_sub_repeat1, 4),
  ...
  [192] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_param_interface, 3),
  ...
  [206] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_lab, 2),
  [208] = {.entry = {.count = 1, .reusable = true}}, SHIFT(69),
  [210] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_sub, 4),
  [212] = {.entry = {.count = 1, .reusable = true}}, SHIFT(25),
  [214] = {.entry = {.count = 1, .reusable = true}}, SHIFT(47),
  [216] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_param_interface, 2),
  [218] = {.entry = {.count = 1, .reusable = true}}, SHIFT(60),
  [220] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_sub, 5),
