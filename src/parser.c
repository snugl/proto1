...
enum {
  ...
  sym_string_format = 82,
  sym_string_format_content = 83,
  sym_open_scope = 84,
  sym_close_scope = 85,
  aux_sym_source_file_repeat1 = 86,
  aux_sym_sequence_repeat1 = 87,
  aux_sym_tree_repeat1 = 88,
  aux_sym_param_interface_repeat1 = 89,
  aux_sym_sub_repeat1 = 90,
  aux_sym_string_content_repeat1 = 91,
};
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [41] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_tree_repeat1, 2), SHIFT_REPEAT(38),
  [44] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_tree_repeat1, 2), SHIFT_REPEAT(59),
  [47] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_tree_repeat1, 2), SHIFT_REPEAT(61),
  [50] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_tree_repeat1, 2), SHIFT_REPEAT(43),
  [53] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_tree_repeat1, 2), SHIFT_REPEAT(51),
  ...
  [65] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_tree_repeat1, 2), SHIFT_REPEAT(52),
  [68] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_tree_repeat1, 2), SHIFT_REPEAT(48),
  [71] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_tree_repeat1, 2), SHIFT_REPEAT(50),
  [74] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_tree_repeat1, 2), SHIFT_REPEAT(62),
  [77] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_tree_repeat1, 2), SHIFT_REPEAT(56),
  ...
  [98] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_expr, 1, .production_id = 1),
  [100] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_expr, 1, .production_id = 1),
  [102] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_paran, 3),
  [104] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_paran, 3),
  [106] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_tree, 2),
  [108] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_close_scope, 1),
  [110] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_tree, 3),
  ...
  [120] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_sub_repeat1, 3),
  [122] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_jump, 4),
  [124] = {.entry = {.count = 1, .reusable = false}}, SHIFT(53),
  [126] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_debug, 2),
  ...
  [134] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_void, 2),
  ...
  [144] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_jump, 3),
  [146] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_put, 4),
  [148] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_trans, 4),
  [150] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_pers, 4),
  [152] = {.entry = {.count = 1, .reusable = true}}, SHIFT(58),
  [154] = {.entry = {.count = 1, .reusable = true}}, SHIFT(57),
  [156] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_iter, 5),
  [158] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_statement, 2),
  [160] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_count, 7),
  [162] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_statement, 1),
  [164] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_enum, 7),
