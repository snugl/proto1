...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [61] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_tree_repeat1, 2), SHIFT_REPEAT(92),
  [64] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_tree_repeat1, 2), SHIFT_REPEAT(86),
  ...
  [190] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_file_repeat1, 2), SHIFT_REPEAT(101),
  [193] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_file_repeat1, 2), SHIFT_REPEAT(116),
  [196] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_file_repeat1, 2), SHIFT_REPEAT(111),
  ...
  [209] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_param_interface_repeat1, 2),
  [211] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_param_interface_repeat1, 2), SHIFT_REPEAT(104),
  [214] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_unit, 1),
  [216] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_string_content_repeat1, 2),
  [218] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_string_content_repeat1, 2), SHIFT_REPEAT(71),
  [221] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_string_content_repeat1, 2), SHIFT_REPEAT(88),
  [224] = {.entry = {.count = 1, .reusable = true}}, SHIFT(83),
  [226] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_routine, 4),
  [228] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_sequence, 4),
  ...
  [236] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_import, 3),
  [238] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_routine, 3),
  ...
  [246] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_sequence, 5),
  ...
  [260] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_jump, 1),
  ...
  [272] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_sub_repeat1, 2),
  [274] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_sub_repeat1, 2), SHIFT_REPEAT(108),
  [277] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_sequence_repeat1, 2),
  [279] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_sequence_repeat1, 2), SHIFT_REPEAT(83),
  [282] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_lab, 1),
  [284] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_string_format, 4),
  [286] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_string_format, 4),
  [288] = {.entry = {.count = 1, .reusable = true}}, SHIFT(110),
  [290] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_string_format, 3),
  [292] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_string_format, 3),
  [294] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_param_def, 3),
  [296] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_rout_name, 1),
  [298] = {.entry = {.count = 1, .reusable = true}}, SHIFT(103),
  [300] = {.entry = {.count = 1, .reusable = true}}, SHIFT(98),
  [302] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_label, 1),
  [304] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_jump, 2),
  [306] = {.entry = {.count = 1, .reusable = true}}, SHIFT(45),
  [308] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_param_name, 1),
  [310] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_sub_repeat1, 4),
  ...
  [318] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_lab, 2),
  [320] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_param_interface, 2),
  [322] = {.entry = {.count = 1, .reusable = true}}, SHIFT(99),
  [324] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_sub, 5),
  [326] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_string_format_content, 3),
  ...
  [334] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_sub, 4),
  [336] = {.entry = {.count = 1, .reusable = true}}, SHIFT(96),
  [338] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_param_interface, 3),
