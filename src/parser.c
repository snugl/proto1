...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [54] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_tree_repeat1, 2), SHIFT_REPEAT(96),
  [57] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_tree_repeat1, 2), SHIFT_REPEAT(90),
  ...
  [175] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_file_repeat1, 2), SHIFT_REPEAT(71),
  [178] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_file_repeat1, 2), SHIFT_REPEAT(95),
  [181] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_file_repeat1, 2), SHIFT_REPEAT(120),
  [184] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_file_repeat1, 2), SHIFT_REPEAT(101),
  ...
  [196] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_routine, 3),
  [198] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_string_content_repeat1, 2),
  [200] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_string_content_repeat1, 2), SHIFT_REPEAT(66),
  [203] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_string_content_repeat1, 2), SHIFT_REPEAT(83),
  [206] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_sequence, 4),
  ...
  [244] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_sub_repeat1, 2),
  [246] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_sub_repeat1, 2), SHIFT_REPEAT(105),
  [249] = {.entry = {.count = 1, .reusable = true}}, SHIFT(106),
  [251] = {.entry = {.count = 1, .reusable = true}}, SHIFT(87),
  [253] = {.entry = {.count = 1, .reusable = true}}, SHIFT(5),
  [255] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_sequence_repeat1, 2),
  [257] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_sequence_repeat1, 2), SHIFT_REPEAT(91),
  [260] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_string_format, 3),
  [262] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_string_format, 3),
  [264] = {.entry = {.count = 1, .reusable = true}}, SHIFT(102),
  [266] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_sequence_repeat1, 1),
  [268] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_string_format, 4),
  [270] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_string_format, 4),
  [272] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_param_def, 3),
  [274] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_lab, 1),
  [276] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_seq_entry, 1),
  [278] = {.entry = {.count = 1, .reusable = true}}, SHIFT(104),
  [280] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_rout_name, 1),
  [282] = {.entry = {.count = 1, .reusable = true}}, SHIFT(94),
  [284] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_label, 1),
  [286] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_jump, 2),
  [288] = {.entry = {.count = 1, .reusable = true}}, SHIFT(54),
  [290] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_sub_repeat1, 4),
  [292] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_param_name, 1),
  [294] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_sub, 5),
  ...
  [306] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_param_interface, 2),
  [308] = {.entry = {.count = 1, .reusable = true}}, SHIFT(99),
  [310] = {.entry = {.count = 1, .reusable = true}}, SHIFT(88),
  [312] = {.entry = {.count = 1, .reusable = true}}, SHIFT(85),
  [314] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_string_format_content, 3),
  [316] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_lab, 2),
  [318] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_sub, 4),
