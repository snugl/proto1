...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [67] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_expr, 1, .production_id = 1),
  ...
  [194] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_param_name, 1),
