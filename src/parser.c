...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [139] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_routine, 4),
  [141] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_param_interface_repeat1, 2),
  [143] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_param_interface_repeat1, 2), SHIFT_REPEAT(77),
  [146] = {.entry = {.count = 1, .reusable = true}}, SHIFT(76),
  [148] = {.entry = {.count = 1, .reusable = true}}, SHIFT(77),
  [150] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_sequence, 5),
  [152] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_unit, 1),
  [154] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_routine, 6),
  [156] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_sequence, 4),
  [158] = {.entry = {.count = 1, .reusable = true}}, SHIFT(85),
  [160] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_import, 3),
  [162] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_routine, 5),
  [164] = {.entry = {.count = 1, .reusable = false}}, SHIFT(49),
  [166] = {.entry = {.count = 1, .reusable = false}}, SHIFT(58),
  [168] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_param_def, 3),
  [170] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_op, 1),
  [172] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_op, 1),
  [174] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_sequence_repeat1, 2),
  [176] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_sequence_repeat1, 2), SHIFT_REPEAT(58),
  ...
  [185] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_sequence_repeat1, 1),
  [187] = {.entry = {.count = 1, .reusable = true}}, SHIFT(78),
  [189] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_sub_repeat1, 2),
  [191] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_sub_repeat1, 2), SHIFT_REPEAT(74),
  ...
  [204] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_jump, 2),
  ...
  [242] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_lab, 2),
  [244] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_param_interface, 3),
