...
enum {
  ...
  aux_sym_routine_repeat1 = 57,
  aux_sym_param_interface_repeat1 = 58,
  aux_sym_sub_repeat1 = 59,
};
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [42] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_routine_repeat1, 2), SHIFT_REPEAT(34),
  ...
  [54] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_routine_repeat1, 2), SHIFT_REPEAT(56),
  [57] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_routine_repeat1, 2),
  [59] = {.entry = {.count = 1, .reusable = true}}, SHIFT(36),
  [61] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_binary, 3, .production_id = 3),
  [63] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_paran, 3),
  [65] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_expr, 1),
  [67] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_expr, 1, .production_id = 2),
  ...
  [79] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_file_repeat1, 2), SHIFT_REPEAT(71),
  [82] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_file_repeat1, 2), SHIFT_REPEAT(61),
  ...
  [105] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_jump, 4),
  [107] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_trans, 4),
  [109] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_put, 4),
  [111] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_pers, 4),
  [113] = {.entry = {.count = 1, .reusable = true}}, SHIFT(25),
  [115] = {.entry = {.count = 1, .reusable = true}}, SHIFT(10),
  [117] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_routine, 6),
  [119] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_param_interface_repeat1, 2),
  [121] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_param_interface_repeat1, 2), SHIFT_REPEAT(58),
  [124] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_sequence, 5),
  ...
  [132] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_routine, 5),
  ...
  [140] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_routine, 4),
  [142] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_sub_repeat1, 2),
  [144] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_sub_repeat1, 2), SHIFT_REPEAT(78),
  [147] = {.entry = {.count = 1, .reusable = true}}, SHIFT(42),
  [149] = {.entry = {.count = 1, .reusable = true}}, SHIFT(52),
  [151] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_sequence_repeat1, 2),
  [153] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_sequence_repeat1, 2), SHIFT_REPEAT(52),
  [156] = {.entry = {.count = 1, .reusable = true}}, SHIFT(40),
  [158] = {.entry = {.count = 1, .reusable = true}}, SHIFT(2),
  [160] = {.entry = {.count = 1, .reusable = true}}, SHIFT(38),
  [162] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_op, 1),
  ...
  [178] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_rout_name, 1, .production_id = 1),
  [180] = {.entry = {.count = 1, .reusable = true}}, SHIFT(66),
  [182] = {.entry = {.count = 1, .reusable = true}}, SHIFT(76),
  [184] = {.entry = {.count = 1, .reusable = true}}, SHIFT(57),
  [186] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_label, 1, .production_id = 1),
  ...
  [194] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_param_name, 1, .production_id = 1),
  ...
  [206] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_param_interface, 2),
  ...
  [220] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_lab, 2),
  [222] = {.entry = {.count = 1, .reusable = true}}, SHIFT(47),
  [224] = {.entry = {.count = 1, .reusable = true}}, SHIFT(39),
  [226] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_sub, 5),
